...
public class Receipt extends JFrame {
    public Receipt(String username, String movie, String theater, String date, String time, String tickets, int fare) {
        ...
        detailsPanel.setBounds(50, 120, 550, 300);  // Reduced height
...
//        addStyledDetailRow(detailsPanel, "Seats:", seats);
        ...
        footerLabel1.setBounds(50, 440, 550, 20);
        add(footerLabel1);
        ...
        footerLabel2.setBounds(50, 460, 550, 15);
        add(footerLabel2);
    ...
    public static void main(String[] args) {
        ...
        new Receipt("John Doe", "Avengers: Endgame", 
                   ...
                   "10:00 AM", "3", 1200).setVisible(true);
    }
}